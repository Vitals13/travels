...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(40.735662128051835, -74.16511807179081)],
	]
	var options = {
		zoom: 10,
		panControl: false,
...
if (document.querySelector(".slider-experiences__body")) {
	new Swiper(".slider-experiences__body", {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
...
//========================================================================================================================================================
if (document.querySelector(".slider-africa__body")) {
	new Swiper(".slider-africa__body", {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	loop: true,
	pagination: {
		el:'.swiper-pagination-africa',
		clickable: true,
	},
	navigation: {
		nextEl: '.slider-button-africa',
		prevEl: '.slider-button-africa'
	},
	breakpoints: {
		320: {
			slidesPerView: 1.1,
...
//========================================================================================================================================================
if (document.querySelector(".slider-asia__body")) {
	new Swiper(".slider-asia__body", {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	loop: true,
	pagination: {
		el:'.swiper-pagination-asia',
		clickable: true,
	},
	navigation: {
		nextEl: '.slider-button-asia',
		prevEl: '.slider-button-asia'
	},
	breakpoints: {
		320: {
			slidesPerView: 1.1,
...
//========================================================================================================================================================
if (document.querySelector(".slider-europe__body")) {
	new Swiper(".slider-europe__body", {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	loop: true,
	pagination: {
		el:'.swiper-pagination-europe',
		clickable: true,
	},
	navigation: {
		nextEl: '.slider-button-europe',
		prevEl: '.slider-button-europe'
	},
	breakpoints: {
		320: {
			slidesPerView: 1.1,
...
//========================================================================================================================================================
if (document.querySelector(".slider-south__body")) {
	new Swiper(".slider-south__body", {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	loop: true,
	pagination: {
		el:'.swiper-pagination-south',
		clickable: true,
	},
	navigation: {
		nextEl: '.slider-button-south',
		prevEl: '.slider-button-south'
	},
	breakpoints: {
		320: {
			slidesPerView: 1.1,
...
//========================================================================================================================================================
if (document.querySelector(".slider-australia__body")) {
	new Swiper(".slider-australia__body", {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	loop: true,
	pagination: {
		el:'.swiper-pagination-australia',
		clickable: true,
	},
	navigation: {
		nextEl: '.slider-button-australia',
		prevEl: '.slider-button-australia'
	},
	breakpoints: {
		320: {
			slidesPerView: 1.1,
...
//========================================================================================================================================================
if (document.querySelector(".slider-antractica__body")) {
	new Swiper(".slider-antractica__body", {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	loop: true,
	pagination: {
		el:'.swiper-pagination-antractica',
		clickable: true,
	},
	navigation: {
		nextEl: '.slider-button-antractica',
		prevEl: '.slider-button-antractica'
	},
	breakpoints: {
		320: {
			slidesPerView: 1.1,
...
//========================================================================================================================================================
if (document.querySelector(".slider-north__body")) {
	new Swiper(".slider-north__body", {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	loop: true,
	pagination: {
		el:'.swiper-pagination-north',
		clickable: true,
	},
	navigation: {
		nextEl: '.slider-button-north',
		prevEl: '.slider-button-north'
	},
	breakpoints: {
		320: {
			slidesPerView: 1.1,
...
if (document.querySelector(".luxury__body")) {
	new Swiper(".luxury__body", {
		slidesPerView: 2,
		spaceBetween: 10,
...
let blogItems = document.querySelectorAll('.experiences__column');
if (blogItems.length > 0) {
	let blogFilters = document.querySelectorAll('.experiences__filter');
	if (blogFilters.length > 0) {
		for (let index = 0; index < blogFilters.length; index++) {
			...
			blogFilter.addEventListener("click", function (e) {
				...
				const blogFilterActive = document.querySelector('.experiences__filter._active');
		...
		function showBlogItems(filter) {
			for (let index = 0; index < blogItems.length; index++) {
				...
				if (filter === 'all' || !filter) {
					...
					if (blogItem.classList.contains('experiences__column_' + filter)) {
						blogItem.classList.remove('_hide');
					}
				}
			}
